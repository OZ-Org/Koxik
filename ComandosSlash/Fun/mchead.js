...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('mchead')
        .setDescription('Obtém a cabeça de um jogador do Minecraft')
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const headURL = `https://crafatar.com/renders/head/${playerUUID}?overlay`;
            const file = new Discord.AttachmentBuilder(headURL, { name: 'cabeca.png' });

            await interaction.editReply({ content: `Cabeça de ${playerName}:`, files: [file] });
        } catch (error) {
            console.error('Erro ao obter a cabeça do jogador:', error);
